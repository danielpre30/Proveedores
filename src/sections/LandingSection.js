...
class LandingSection extends Component {
    render() {
        ...
        if (this.props.logIn){
            ...
            description=<><DescriptionContainer srcImage={agreement} title="Crea Alianzas estratégicas" description="Conoce nuevas empresas contratantes y proveedoras para satisfacer tus necesidades y als de ellos."/>
