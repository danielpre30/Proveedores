        ...
        return (
            <div className="landing-section">
                <div className="landing__register-info">
                    ...
                    <input className="reg__input" name="creationYear"  placeholder="Año fundación" />
                    <p className="regInfo__text">Dirección URL a la página web de la empresa:</p>
                    <input className="reg__input" name="webPageURL"  placeholder="URL a la página web" />
                    <p className="regInfo__text">Dirección URL a el logo de la empresa:</p>
                    <input className="reg__input" name="logoURL"  placeholder="URL a la página web" />
                    <br/>
                    <input className="button-register" name="Submit"  type="submit"  value="Registrarse" />
                    </form>
